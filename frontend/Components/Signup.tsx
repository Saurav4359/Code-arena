    ...
    <>
        <div className="bg-gray-200 h-150 w-180 rounded-2xl p-2 border-solid border-black/60 border  ">
          <div className=" h-48 border-black ">
            ...
            <div className=" h-10 w-80 font-normal font-stretch-150% flex justify-baseline items-baseline-last pl-10 ml-44 pointer-events-none">
              I already have my account
            </div>
            <div className=" h-18 flex items-center ml-38">
              <button className=" h-13 w-100 flex justify-center items-center border border-gray-600 rounded-4xl gap-1 hover:bg-gray-200 hover:border-black ">
                <Google />
                Sign in to Google
              </button>
            </div>
          ...
          <div className=" h-46  border-black ">
            <div className="h-3 w-full  flex items-center justify-end pr-36 font-thin text-sm">
              Required Fields*
            </div>
            ...
            <div className=" h-14 flex justify-center items-center mb-2">
              <input
                className=" h-12 w-100 border border-black/50 rounded font-serif flex items-center px-2 hover:border-black focus:outline-black "
                placeholder="Email"
                type="text"
                name=""
                id=""
            ...
            <div className=" cursor-pointer h-3 w-full    flex items-center  justify-start pl-38 font-thin underline text-sm hover:text-gray-500">
          ...
          <div className="   h-50  border-black ">
            <div className=" h-15  flex justify-center items-center">
              <button className="h-14 w-80 bg-black rounded-4xl text-white font-stretch-100% hover:border hover:border-gray-300 cursor-pointer">
                Sign In
              </button>
            </div>
            <div className="  h-32 mt-5 border-t border-slate-500 font-thin m-40">
              ...
              <div className=" h-18 flex justify-center items-center">
                <button className="h-14 w-80 bg-black text-white rounded-4xl font-medium hover:border hover:border-gray-300 cursor-pointer">
                  Create Account
                </button>
              </div>
            </div>
